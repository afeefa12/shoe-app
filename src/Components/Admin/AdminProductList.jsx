...
const AdminProducts = () => {
  ...
  const handleAddFormSubmit = async (e) => {
    ...
    try {
      ...
      setAddFormData({ name: '', price: '', categories: '', images: '' });
      setError(null);
    } catch (err) {
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
        ...
        <div className="flex gap-4 w-full sm:w-auto">
          <input
            ...
            className="px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-400 w-full sm:w-64"
          />
          <button
            onClick={() => setIsAddingProduct(true)}
            className="bg-yellow-500 text-white px-6 py-2 rounded-lg hover:bg-yellow-600 transition-colors duration-200 font-medium whitespace-nowrap"
          >
            Add Product
          </button>
        </div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm">
                      <div className="flex items-center gap-4">
                        ...
                        <button
                          ...
                          className="text-yellow-600 hover:text-red-800 font-medium transition-colors"
                        >
                          Delete
                        </button>
                      </div>
          ...
          <form onSubmit={handleEditFormSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-yellow-400"
                required
              />
            </div>
            <div>
